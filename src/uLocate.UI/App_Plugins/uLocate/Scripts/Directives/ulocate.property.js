// Shamelessly adapted from Archetype (c) 2014 Imulus https://github.com/imulus/Archetype
angular.module("umbraco.directives").directive('ulocateProperty', function ($compile, $http, archetypePropertyEditorResource, umbPropEditorHelper, $timeout, $rootScope, $q, editorState) {
